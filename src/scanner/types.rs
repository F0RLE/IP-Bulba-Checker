...
pub struct ScanPolicy {
    ...
    pub max_browser_verifications: usize,
    pub max_parallel_browser_tabs: usize,
    pub browser_verify_all: bool,
...
impl ScanPolicy {
    pub const fn safe() -> Self {
        Self {
            ...
            max_browser_verifications: 8,
            max_parallel_browser_tabs: 1,
            browser_verify_all: false,
    ...
    pub const fn aggressive() -> Self {
        Self {
            ...
            max_browser_probe_paths: 2,
            max_browser_verifications: 96,
            max_parallel_browser_tabs: 2,
            browser_verify_all: false,
